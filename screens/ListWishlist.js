...
export default class ListWishlist extends React.Component {
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <Button
                                ...
                                onPress={() => { this.props.navigation.navigate('ViewCampaign', { id: campaign._id }) }}
                                title='$ Contribute' />
                        </View>
                    </View>
                </Card >
...
ListWishlist.navigationOptions = {
    header: null,
};
